...
$config = array(
      ...
      'success_page' => array(
        ...
        'value' => '',
        'columnWidth' => 50,
        'description' => 'Page to redirect to after a successful submission. URL follows the current language automatically.',
      ),
      'error_page' => array(
        'label' => 'Error Page',
        'type' => 'PageListSelect',
        'value' => '',
        'columnWidth' => 50,
        'description' => 'Page to redirect to after a failed submission. URL follows the current language automatically.',
      ),
      'success_url' => array(
        'label' => 'Success URL (fallback)',
        'type' => 'text',
        'value' => '',
        'columnWidth' => 50,
        'description' => 'Optional manual path if no success page is selected above.',
        'notes' => 'e.g. /de/kontakt/danke',
        'useLanguages' => true,
      ),
      'error_url' => array(
        'label' => 'Error URL (fallback)',
        'type' => 'text',
        'value' => '',
        'columnWidth' => 50,
        'description' => 'Optional manual path if no error page is selected above.',
        'notes' => 'e.g. /de/kontakt/fehler',
        'useLanguages' => true,
      ),
